        ...
        <div class="card spur-card">
            <div class="card-header d-flex flex-row justify-content-between">
                    ...
                    <div class="spur-card-title">
                        <a href="{{ route('projects.restoreAll') }}" class="btn btn-primary"><i class="fas fa-undo"></i> Restore All</a>
                    </div>
                            ...
                            @forelse ($projects as $project)
                                <tr>
                                    ...
                                    <td class="d-flex flex-row justify-content-center">
                                        <a href="{{ route('projects.restore', ['id' => $project->id]) }}" class="btn btn-success btn-sm mx-1"><i class="fas fa-undo"></i> Restore</a>
                                    </td>
                                </tr>
                            @empty
